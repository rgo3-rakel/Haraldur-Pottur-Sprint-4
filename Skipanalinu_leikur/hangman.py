...
class Hangman():
    ...
    def wordPuzzle(self):
        self.rightWord = random.choice(self._words)

        #Setjum _ í stað fjölda þeirra stafa sem eru í random orðinu.
        emptyLetter = "_" * len(self.rightWord)

        guessCountdown = 10
        #Söfnum guesses spilara í lista til að hafa bókhald
        guesses = []

        while guessCountdown >= 0 and not emptyLetter == self.rightWord:
            print(emptyLetter)
            ...
            if self.guessLetter in guesses:
            ...
            elif self.guessLetter in self.rightWord:
                ...
                emptyLetter = self.rightGuess(self.rightWord, emptyLetter, self.guessLetter)
                ...
                guesses.append(self.guessLetter)
                if guessCountdown <= 0:
                    print("Æji nei, rétta orðið var: " + self.rightWord + ".\n")
                    break
        ...
        if guessCountdown == 0:
            ...
            print ("Jibbí til hamingju! Leyniorðið var: " + self.rightWord + "! Þú ert hér með búinn að ná öllum prófum Hogwarts og nú er ekkert annað til fyrirstöðu en að fagna og útskrifast...")
            win = "win"
            return win
